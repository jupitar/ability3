        ...
        holder.appItemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (AppStoreUtils.checkUpgrade(activity, i)) {
                    ...
                    if (i.packageName.equals("com.ict.liaction.check") || i.packageName.equals("cn.com.starit.ess.mobile.view.labelprint") || i.packageName.equals("com.kdgc.bluetoothprinter")) {
                        AppStoreUtils.launchAppByInfo(activity, i);
                    } else {
                        RequestParams requestParams = new RequestParams();
                        activity.showProgressBar();
                        try {
                            requestParams.put("packageName", i.packageName);
                            ...
                            public void onSuccess(JSONObject responseObj) {
                                ...
                                try {
                                    if (responseObj.get("code").equals("0")) {
                                        AppStoreUtils.launchAppByInfoByCodeByRedirectUri(activity, i,responseObj.getJSONObject("data").getString("code"), responseObj.getJSONObject("data").getString("redirectUri"));
                                    } else {
